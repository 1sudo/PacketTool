...
public class Algorithm : HashAlgorithm
{
	public Algorithm()
	{
		this.table = InitializeTable(3988292384U);
		this.seed = uint.MaxValue;
		this.Initialize();
	}

	public Algorithm(uint polynomial, uint seed)
	{
	...
	private static uint CalculateHash(uint[] table, uint seed, byte[] buffer, int start, int size)
	{
		...
		{
			num = (table[(int)((UIntPtr)((uint)buffer[i] ^ num >> 24))] ^ num << 8);
		}
		return ~num;
	}
